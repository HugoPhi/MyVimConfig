" 2023.4.22 | For mobilephone on termux
...
Plug 'nvim-tree/nvim-web-devicons'                                 " bufferline
...
"--------------tree-sitter-----------------------
nmap <F1> :TSEnable highlight<CR> 
" autocmd Syntax * :TSEnable highlight<CR> 
...
" set guifont=Caskaydia_Cove_Nerd_Font_Complete_Bold:h14
