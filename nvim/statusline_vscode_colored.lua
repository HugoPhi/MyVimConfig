...
M.fileInfo = function()
  ...
  return "%#St_InsertMode# " .. icon .. filename
end
...
M.git = function()
  ...
  return "%#St_VisualMode#  " .. vim.b.gitsigns_status_dict.head .. " "
end
...
M.gitchanges = function()
  ...
  return (added .. changed .. removed) ~= "" and ("%#St_Mode#│" .. added .. changed .. removed) or ""
end
...
M.LSP_Diagnostics = function()
  ...
  local sum = errors + warnings + hints + info
  ...
  hints = (hints and hints > 0) and ("%#St_lspHints# 󱩎 " .. hints .. "") or ""
  info = (info and info > 0) and ("%#St_lspInfo#  " .. info .. "") or ""

  -- return vim.o.columns > 140 and errors .. warnings .. hints .. info or ""
  if sum > 0 then
    return vim.o.columns > 80 and errors .. warnings .. hints .. info or ""
  else
    return "%#St_lspInfo#  Lsp Pass"
  end
end

M.filetype = function()
  -- return vim.bo.ft == "" and "%#St_ft#│ {} plain text  " or "%#St_ft#│ {} " .. vim.bo.ft .. " "
  return vim.bo.ft == "" and "%#St_Mode#│ %#St_lspWarning#󰈚 plain text  " or "%#St_Mode#│ %#St_lspWarning#󰈚 " .. vim.bo.ft .. " "
end
  ...
  if rawget(vim, "lsp") then
    for _, client in ipairs(vim.lsp.get_active_clients()) do
      if client.attached_buffers[vim.api.nvim_get_current_buf()] and client.name ~= "null-ls" then
        -- return (vim.o.columns > 80 and "%#St_ft#│%#St_LspStatus# 󰄭  " .. client.name .. " ") or "%#St_ft#│ 󰄭  LSP  "
        return (vim.o.columns > 120 and "%#St_Mode#│%#St_LspStatus#   " .. client.name .. " ") or ""
      end
    end
  end
end
...
M.cursor_position = function()
  -- return vim.o.columns > 140 and "%#St_lspInfo# Ln %l, Col %c  " or ""
  return vim.o.columns > 80 and "%#St_Mode#│ %#St_ft#Ln %l of %L, Col %c " or ""
end

M.file_encoding = function()
  return string.upper(vim.bo.fileencoding) == "" and "" or "%#St_Mode#│ %#St_lspWarning# " .. string.upper(vim.bo.fileencoding) .. " "
end

M.cwd = function()
  local dir_name = "%#St_Mode#│ %#St_cwd# 󰉖 " .. fn.fnamemodify(fn.getcwd(), ":t") .. " "
  -- return (vim.o.columns > 85 and dir_name) or ""
  return (vim.o.columns > 120 and dir_name) or ""
end
